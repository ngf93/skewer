        ...
        <>
            <header>
                <div className="container">
                    <NavLink exact to={HOME_ROUTE} className="logo"><img src='/images/logo.svg' alt="Шампур" /></NavLink>
                    <div className='flex-1'>
                        <div className='d-flex justify-content-between align-items-center fs-11'>
                            <form className='form-search d-flex align-items-justify'>
                                <input type="search" placeholder='Поиск по сайту...' />
                                <button type='submit' className='btn btn-1'>Найти</button>
                            </form>
                                ...
                                <ul>
                                    ...
                                    <li>
                                    {
                                        ...
                                        <NavLink to={PROFILE_ROUTE} type="button" className="d-none d-md-flex btn-svg">
                                            ...
                                            <img src='/images/icons/enter.svg' alt="Личный кабинет" className='icon ms-2'/>
                                        </NavLink>
                                        :
                                    ...
                                    <li>
                                        <div id="toggle-cart">
                                            <NavLink to={CART_ROUTE} onMouseEnter={() => setIsShown(true)} onMouseLeave={() => setIsShown(false)} className="position-relative">
                                                <img src='/images/icons/cart.svg' alt="Корзина" className='icon me-2'/>
                                                <span>Корзина</span>

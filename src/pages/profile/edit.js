                    ...
                    <div className="row">
                        ...
                        <div className="col-md-8 col-xl-7 col-xxl-6 offset-xl-1">
                            <form onSubmit={submit} onChange={change} >
                                ...
                                <fieldset className="mb-4 mb-sm-5">
                                    <legend className="fw-5 fs-11 mb-3">День рождения</legend>
                                    <div className="row gx-xl-5">
                                        ...
                                        <div className="col-sm-6 col-lg-7 mt-2 mt-sm-0">
                                            <div className="gray-5 mb-1">Дарим 10% скидки в день рождения</div>
                                            <div className="gray-5">Можно указать только один раз</div>
                                        </div>
                                    </div>
                                </fieldset>

                                <fieldset className="mb-4 mb-sm-5">
                                    <legend className="fw-5 fs-11 mb-3">Мой пол</legend>

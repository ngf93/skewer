                    ...
                    <div className="row">
                        ...
                        <div className="col-md-8 col-xl-7 col-xxl-6 offset-xl-1">
                            ...
                            <div className="mb-5">
                                ...
                                <div className="gray-4 fs-09 mb-4">Добавьте карту для быстрой и безопасной оплаты заказов</div>
                                <div className="fs-09 mb-4">
                                    <div>Visa</div>
                                    <div className="gray-4 mt-1">**** **** **** 7685</div>
                                    <div className="d-flex mt-1">
                                        <button type="button" className="fs-09 me-3">Редактировать</button>
                                        <button type="button" className="fs-09 gray-5">Удалить</button>
                                    </div>
                                </div>
                                <div className="fs-09 mb-4">
                                    <div>Mastercard</div>
                                    <div className="gray-4 mt-1">**** **** **** 1234</div>
                                    <div className="d-flex mt-1">
                                        <button type="button" className="fs-09 me-3">Редактировать</button>
                                        <button type="button" className="fs-09 gray-5">Удалить</button>
                                    </div>

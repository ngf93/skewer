                    ...
                    <div className="row">
                        ...
                        <div className="col-md-8 col-xl-7 col-xxl-6 offset-xl-1">
                            <div className="mb-5">
                                ...
                                <div className="fw-5 mt-4">Номер скидочной карты</div>
                                <div className="mt-2">№ 4556 8900 3765</div>
                                <div className="fw-5 mt-4">Оплачивайте заказы баллами!</div>
                                <div className="mt-2">10 баллов = 1 рубль</div>
                                <div className="fw-5 mt-4">Уровень начислений</div>
                                <div className="mt-2">Сейчас вы получаете 6% от каждого заказа. Совершите покупки от <span className="primary">10 000 ₽</span> и получайте 8%.</div>
                            ...
                            {/* <div className="fw-5 fs-12 mb-4">История баллов</div>

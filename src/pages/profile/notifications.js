                    ...
                    <div className="row">
                        ...
                        <div className="col-md-8 col-xl-7 col-xxl-6 offset-xl-1">
                            ...
                            <div className="w-fit mb-5">
                                ...
                                <div className="gray-4 text-center">Здесь ещё не было <br /> уведомлений</div>
                            </div>
                                ...
                                <div className="col-lg-8">
                                    ...
                                    <div className="notification type-2 mb-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="gray-5 mb-2">Дарим персональную скидку и 2 пиццы перерони в подарок!</div>
